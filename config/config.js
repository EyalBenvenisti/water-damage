...
const config = {
  siteName: "Water Damage Experts",
  siteOwner: "Mike Johnson",
  phone: "(555) 555-5555",
  email: "info@waterdamage.com",
  ...
  socialLinks: {
    ...
    twitter: "https://twitter.com/waterdamage",
    instagram: "https://instagram.com/waterdamage",
  },

  // Brand Information
  brand: {
    mission: "To provide prompt, thorough, and effective water damage restoration services to the families and businesses of Chanhassen. We’re committed to helping our customers restore their homes and peace of mind with integrity, transparency, and a deep sense of care.",
    vision: "To become the go-to name for water damage restoration in Chanhassen and beyond, building lasting relationships with our customers and making a positive impact on our community by treating each property as if it were our own.",
    values: [
