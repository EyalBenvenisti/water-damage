  ...
  return (
    <>
      ...
      <main role="main" className="container">
        <section aria-labelledby="about-heading" className="lg:px-0">
            <h2 className="text-3xl font-semibold mb-4">Our Why</h2>
            <p className="mb-6">
            ...
            <h2 className="text-3xl font-semibold mb-4">Our Commitment to the Community</h2>
            <p className="mb-6">
      ...
      <section aria-labelledby="cta-heading" className="mt-12 bg-orange text-white py-8 text-center">
        <h2 id="cta-heading" className="text-3xl font-semibold">Ready to Restore Your Home?</h2>
